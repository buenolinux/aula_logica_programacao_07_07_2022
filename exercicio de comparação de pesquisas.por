...
inteiro i,x, bkp, quantidade = 10, numero_digitado
	...
	funcao inicio()
	{
		...
		//pesquisa_linear(numero_digitado,quantidade)
		pesquisa_binaria(numero_digitado,  encontrado)
	...
	funcao pesquisa_linear(inteiro numero_digitado, inteiro quantidade)
	{
		// Pesquisa linear
	...
	funcao pesquisa_binaria(inteiro numero_digitado, logico encontrado)
	{
